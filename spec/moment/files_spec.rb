...
FILES_TEST_DIR_NAME = "test_dir"

describe Moment::Files, :fakefs do 

  before {Moment::FileTree.new(files, FILES_TEST_DIR_NAME).build_tree}

  after{Moment::FileTree.delete FILES_TEST_DIR_NAME}

  let(:file_list){Moment::Files.get_file_list(FILES_TEST_DIR_NAME)}
  ...
  describe "with one file" do
    ...
    it "should get a collection of files paths within a directory" do
      Moment::FileTree.verify_files(files, file_list, FILES_TEST_DIR_NAME)
    end
  end
